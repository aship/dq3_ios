    ...
    NSCoding
{
    ...
    required init?(coder decoder: NSCoder) {
        self.dqSceneType = DQSceneType(
            rawValue: decoder.decodeObject(forKey: "dqSceneType") as! String)!
        ...
        self.partyCharacterNodes =
            decoder.decodeObject(forKey: "partyCharacterNodes") as! [CharacterNode]
        self.partyCharacterStatuses =
            decoder.decodeObject(forKey: "partyCharacterStatuses") as! [CharacterStatus]
    }
}
