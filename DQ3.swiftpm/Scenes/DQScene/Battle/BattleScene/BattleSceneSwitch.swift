...
extension BattleScene {
    ...
    func switchMessageWindowToCommandWindow(
        ...
        self.addCommandWindow(
            battleCommandWindowNode: &battleCommandWindowNode,
            characterStatuses: partyCharacterStatuses,
            index: 0,
            scene: scene,
            scale: scale)

        self.addTargetWindow(
            battleTargetWindowNode: &battleTargetWindowNode,
            monsterGroups: monsterGroups,
            scene: scene,
            scale: scale)
    }

    private func switchCommandWindowToCommandWindow(
        battleCommandWindowNode: inout BattleCommandWindowNode,
        battleTargetWindowNode: inout BattleTargetWindowNode,
