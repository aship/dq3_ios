...
extension AdventureLogSelectEmptyLogWindowNode {
    func processButtonA() {
        ...
        if dqAdventureLogTop == .create {
            self.adventureLogInputNameWindowNode = AdventureLogInputNameWindowNode(
                adventureLogNumber: emptyAdventureLogNumber)
            ...
            let adventureLog = UserDefaultsUtil.loadAdventureLog(
                number: copyFromAdventureLogNumber)!
