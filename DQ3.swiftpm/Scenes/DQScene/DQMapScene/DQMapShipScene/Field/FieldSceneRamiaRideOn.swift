...
extension FieldScene {
    func processRideOnRamia(
        ...
        if characterNodes.count == 1 || queueFollowDirections.count == 0 {
            // ラーミアに降りてすぐ乗った時に
            // パーティが2人以上のとき必要な処理
        ...
        node.move(
            ...
            completion: {
                ...
                self.process3rdCharacterMove(
                    partyCharacterNodes: DataManager.adventureLog.partyCharacterNodes,
    ...
    private func process3rdCharacterMove(
    ...
    private func process4thCharacterMove(
        partyCharacterNodes: [CharacterNode],
        queueFollowDirections: [Direction],
        ramiaNode: CharacterNode,
        tileMapNode: SKTileMapNode,
