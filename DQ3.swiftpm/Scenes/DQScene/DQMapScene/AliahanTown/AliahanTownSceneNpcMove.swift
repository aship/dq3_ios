...
extension AliahanTownScene {
    func setNpcMove(
        ...
        if dqStory == .opening || dqStory == .mother_waiting {
            return
        }
        ...
        for node in characterNpcNodes {
            if node.name == "boy2" || node.name == "warrior1" || node.name == "warrior2"
                || node.name == "old_man2" || node.name == "luida" || node.name == "luida_talk"
                || node.name == "inn" || node.name == "inn_talk" || node.name == "depository"
                || node.name == "depository_talk" || node.name == "weapon_shop"
                || node.name == "weapon_shop_talk" || node.name == "tool_shop"
                || node.name == "tool_shop_talk" || node.name == "priest"
            {
