...
class MapCommandWindowNode: SKTileMapNode {
    ...
    // ここをマップ分用意するのか、、、、
    var talkMessageWindowAliahanTown = TalkMessageWindowAliahanTown(characterNpcNodes: [])
    var talkMessageWindowAliahanTownHouse = TalkMessageWindowAliahanTownHouse(characterNpcNodes: [])
    
    var isTalkMessageWindowOpen = false
