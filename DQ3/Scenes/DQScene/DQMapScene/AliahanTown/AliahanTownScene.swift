...
<<<<<<<< HEAD:DQ3.swiftpm/Scenes/DQMapScene/AliahanTown/AliahanTownScene.swift
...
========
        ...
        if dqStory == .opening {
>>>>>>>> aa4b000 (bumping version 0.6 using only one SKScene because of PS4 controller problem):DQ3/Scenes/DQScene/DQMapScene/AliahanTown/AliahanTownScene.swift
