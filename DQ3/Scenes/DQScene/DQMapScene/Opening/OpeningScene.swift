...
class OpeningScene: DQMapScene {
    ...
    func setup() {
<<<<<<<< HEAD:DQ3.swiftpm/Scenes/DQMapScene/Opening/OpeningScene.swift
        DataManager.dqSceneType = .opening

========
        DataManager.adventureLog.dqSceneType = .opening
        
>>>>>>>> aa4b000 (bumping version 0.6 using only one SKScene because of PS4 controller problem):DQ3/Scenes/DQScene/DQMapScene/Opening/OpeningScene.swift
