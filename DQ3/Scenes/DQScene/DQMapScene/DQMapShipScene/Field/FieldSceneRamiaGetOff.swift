...
extension FieldScene {
    func checkGetOffRamia(tileMapNode: SKTileMapNode,
                          positionX: Int,
                          positionY: Int) -> Bool {
        let tileGroup = tileMapNode.tileGroup(atColumn: positionX,
                                              row: positionY)
    ...
    func processGetOffRamia(tileMapNode: SKTileMapNode,
