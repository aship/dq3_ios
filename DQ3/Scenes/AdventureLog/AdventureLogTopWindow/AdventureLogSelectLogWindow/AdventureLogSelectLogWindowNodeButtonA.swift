...
extension AdventureLogSelectLogWindowNode {
    func processButtonA() {
        ...
        if dqAdventureLogTop == .go {
            ...
            DataManager.adventureLog = UserDefaultsUtil.loadAdventureLog(number: adventureLogNumber)!
            ...
            self.adventureLogMessageSpeedWindowNode = AdventureLogMessageSpeedWindowNode(dqAdventureLogTop: dqAdventureLogTop,
            ...
            self.adventureLogYesNoDeleteLogWindowNode = AdventureLogYesNoDeleteLogWindowNode(adventureLogNumber: adventureLogNumber)
