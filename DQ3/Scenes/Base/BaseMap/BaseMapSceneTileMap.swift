...
extension BaseMapScene {
    ...
    func addMainTileMap(name: String,
                        ...
                        numberOfImages: Int,
                        scale: CGFloat) {
        tileMapNode = generateTileMap(name: name,
    ...
    func addInsideTileMap(name: String,
                          ...
                          numberOfImages: Int) {
        insideTileMapNode = generateTileMap(name: name,
                                            numberOfImages: numberOfImages)
        insideTileMapNode?.alpha = 0
    ...
    private func generateTileMap(name: String,
                                 numberOfImages: Int) -> (SKTileMapNode) {
    ...
    func getTileMapNode(dqSceneType: DQSceneType) -> SKTileMapNode {
        ...
        case .battle: break
        case .opening: break
        case .field: tileMapNode = self.fieldScene.mainTileMapNode
