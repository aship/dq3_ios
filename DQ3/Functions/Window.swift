...
func generateWindow(pointX: Int,
                    pointY: Int,
                    numberOfColumns: Int,
                    numberOfRows: Int,
                    scale: CGFloat) -> SKTileMapNode {
    let size8 = CGSize(width: 8, height: 8)
    ...
    tileMapNode.anchorPoint = CGPoint(x: 0,
                                      y: 1)
    tileMapNode.position = CGPoint(x: CGFloat(pointX) * scale,
